...
//#define BALANCE_KP 15// 15 PID Constants
//#define BALANCE_KI 50 // 90
...
#define PWM_MIN 0
#define PWM_MAX 255
float MOTORSLACK_A=39;                     // Compensate for motor slack range (low PWM values which result in no motor engagement)
